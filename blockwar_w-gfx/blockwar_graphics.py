...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color):
        graphic = pygame.image.load('player.png').convert_alpha()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        graphic2 = pygame.image.load('player2.png').convert_alpha()
        self.image = graphic2
        self.ammo = 10
        self.frags = 0
        self.level = 1
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, start_x, start_y, dest_x, dest_y):
        ...
        self.floating_point_x = start_x + 25
...
while not done:
    ...
    if player.frags <= -1000:
        losetext = winlose_message.render("you suck! [esc] to end [space] to restart",0,(BLACK))
        screen.blit(losetext,(5,SCREEN_HEIGHT/2))
        pygame.display.flip()
        wait()
    if player.frags >= 1000:
        wintext = winlose_message.render("you win!  [esc] to end [space] to restart",0,(BLACK))
    ...
    scoretext = scoreboard.render(scores,0,(BLACK))
    instructiontext = scoreboard.render("arrows/mouse - esc to exit",0,(BLACK))
    ...
    mouse_x = pos[0]
    mouse_y = pos[1]
    pygame.draw.circle(screen,BLACK,[mouse_x,mouse_y],3,2)
